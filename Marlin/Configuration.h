...
#define STRING_CONFIG_H_AUTHOR "Alkanex" // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, X2_HOME_POS } // (mm) relative X-offset for each nozzle
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  15.16,  15.16 }
    #define DEFAULT_Ki_LIST {   1.16,   1.16 }
    #define DEFAULT_Kd_LIST {  49.38,  49.38 }
  #else
